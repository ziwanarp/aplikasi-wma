                        ...
                        <div class="card">
                            <div class="card-block">
                                ...
                                <?php
                                    include "kns.php";
                                    extract($_GET);
                                    $e=mysqli_query($kns,"select * from tb_barang where id_barang='$id'");
                                ...
                                <form method="GET" action="update_barang.php">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <input readonly type="text" placeholder="Masukan kode barang" class="form-control form-control-line" name="id" value='<?php echo"$data[id_barang]";?>'>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <input type="text" placeholder="Masukan nama barang" class="form-control form-control-line" name="nama" value='<?php echo"$data[nama_barang]";?>'>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                            <label class="col-md-4">Satuan</label>
                                            <div class="col-md-3">
                                                <input type="text" placeholder="Masukan Satuan" class="form-control form-control-line" name="satuan" value='<?php echo"$data[satuan]";?>'>
                                            </div>
                                        </div>
                                    <div class="form-group">
                                            <label class="col-md-4">Harga (Rp.)</label>
                                            <div class="col-md-3">
                                                <input type="number" placeholder="Masukan harga" class="form-control form-control-line" name="harga" value='<?php echo"$data[harga]";?>'>
                                            </div>
                                        </div>
                                    <!-- <div class="form-group">
                                            <label class="col-md-4">Stok</label>
                                            <div class="col-md-3">
                                                <input type="number" placeholder="Masukan stok" class="form-control form-control-line" name="stok"  value='<?php echo"$data[stok]";?>'>
                                            </div>
                                    </div> -->
                                    <div class="form-group">
                                        <div class="col-sm-12">
