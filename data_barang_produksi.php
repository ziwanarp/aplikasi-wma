                                    ...
                                    while ($y = mysqli_fetch_array($t)) {
                                        echo "<tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a onclick=\"return confirm('Hapus data ?');\" class=\"btn btn-sm btn-danger\" href=hapus_barang.php?id=$y[id]&id_barang=$y[id_barang] onClick='return confirm(\"Anda yakin menghapus data ini?\")';><span class=\"glyphicon glyphicon-remove\"></span> Hapus</a>
                                                    </td>
                                                </tr>";
                                        $no++;
                                    }
