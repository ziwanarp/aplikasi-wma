                        ...
                        <div class="card">
                            <div class="card-block">
                                ...
                                <div class="form-group">
                                    <a href="data_pembelian_input.php" class="btn waves-effect waves-light btn-primary">Tambah data pembelian</a>
                                </div>
                            </div>
                            <div class="table-responsive">
                                <table class="table">
                                    <thead>
                                        ...
                                        INNER JOIN tb_produksi ON tb_penjualan.kode_barang_pk = tb_produksi.kode_barang WHERE nama_pembeli = '$_SESSION[name]'") or die(mysqli_error($kns));
                                        if (mysqli_num_rows($t) > 0) {
                                            while ($y = mysqli_fetch_array($t)) {
                                                ...
                                                switch ($y['status']) {
                                                    case 2:
                                                        echo "<a class=\"btn btn-sm btn-warning\"href=#>PENDING</a>";
                                                        break;
                                                    case 0:
