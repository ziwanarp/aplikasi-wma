            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Data Request Pembelian</h3>
                                ...
                                <table class="table">
                                    <thead>
                                        ...
                                        $t = mysqli_query($kns, "SELECT 
                                                  ...
                                                  from tb_penjualan
                                                  INNER JOIN tb_barang ON tb_penjualan.id_barang=tb_barang.id_barang WHERE status IN (0,1,2)") or die(mysqli_error($kns));
                                        if (mysqli_num_rows($t) > 0) {
                                            while ($y = mysqli_fetch_array($t)) {
                                                ...
                                                switch ($y['status']) {
                                                    case 2:
                                                        echo "
                                                        <a onclick=\"return confirm('ACCEPT pembelian ?');\" class=\"btn btn-sm btn-success\" href=update_status.php?id=$y[id]&status=1> ACCEPT</a>
                                                        <a onclick=\"return confirm('REJECT pembelian ?');\" class=\"btn btn-sm btn-danger\" href=update_status.php?id=$y[id]&status=0> REJECT</a>";
                                                        break;
                                                    case 0:
