            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor">Beranda Owner</h3>
                        ...
                        <div class="card">
                            <div class="card-block">
                                <div class="row">
                                    <div class="col-12">
                                        <center>
                                            <h3 class="card-title align-self-center">SISTEM INFORMASI PERAMALAN PERSEDIAAN UD. RAJABAWANG</h3>
                                        </center>
                                    </div>
                                    <div class="col-12">
