...
<body class="fix-header fix-sidebar card-no-border">
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
                        ...
                        <div class="card">
                            <div class="card-block">
                                <div class="row">
                                    <div class="col-12">
                                        <center>
                                            <h3 class="card-title align-self-center">Selamat Datang <?php echo $_SESSION['username'] ?> di Sistem Informasi Peramalan Persediaan di UD. Rajabawang</h3><br>
                                            <h3>Terimakasih sudah bergabung dengan kami</h3>
                                        </center>
                                    </div>
                                    <div class="col-12">
            ...
            <!-- footer -->
            <!-- ============================================================== -->
            <footer class="footer" align="center"> © Copyright Efan Febriana 2023 </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
        </div>
