                        ...
                        <div class="card">
                            ...
                            <div class="card-block">
                                <div class="form-group">
                                        <a href="data_user_input.php" class="btn waves-effect waves-light btn-primary">Tambah data</a>
                                    </div>
                                </div>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <?php 
                                                include 'kns.php';
                                                $no=1;
                                                $data_user = mysqli_query($kns,"select * from tb_user") or die(mysqli_error($kns));
                                                if(mysqli_num_rows($data_user)>0)
                                                {
                                                    while ($y=mysqli_fetch_array($data_user)) 
                                                    {
                                                        $num=$no++;
                                                    echo "
                                                        <tr>
                                                            ...
                                                            <td>$y[nama_user]</td>
                                                            <td>
                                                                <a class=\"btn btn-sm btn-info\"href=edit_user.php?id=$y[id_user]><i class=\"glyphicon glyphicon-pencil\"></i> Edit</a>
                                                        <a class=\"btn btn-sm btn-danger\" href=hapus_user.php?id=$y[id_user] onClick='return confirm(\"Anda yakin menghapus data ini?\")';><i class=\"glyphicon glyphicon-trash\"></i> Hapus</a>
                                                            </td>
                                                    </tr>
                                                    ";
                                                    }
