                                    ...
                                    <table class="table">
                                        <thead>
                                            ...
                                            <?php
                                                include "kns.php";
                                                $num = 1;
                                                $t=mysqli_query($kns,"select * from tb_supplier");
                                               if (mysqli_num_rows($t)) {
                                                ...
                                                echo"<tr>
                                                    <td>$no</td>
                                                    <td>$y[nama_supplier]</td>
                                                    <td>$y[alamat_supplier]</td>
                                                    <td>$y[kota]</td>
                                                    <td>$y[no_tlp]</td>
                                                    <td>$y[email]</td>
                                                    <td>
                                                        <a class=\"btn btn-sm btn-info\"href=edit_supplier.php?id=$y[id_supplier]><span class=\"glyphicon glyphicon-pencil\"></span> Edit</a>
                                                        <a onclick=\"return confirm('Hapus data ?');\" class=\"btn btn-sm btn-danger\" href=hapus_supplier.php?id=$y[id_supplier] onClick='return confirm(\"Anda yakin menghapus data ini?\")';><span class=\"glyphicon glyphicon-remove\"></span> Hapus</a>
                                                    </td>
                                                </tr>";
                                                }
                                               }
